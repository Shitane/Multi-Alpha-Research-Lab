...
public:
 void Create(const SO01RuntimeSettings110&s){
  p="O01CFG131_";st.SetFile("O01_GSG_RSI30_Settings_v1_10.csv");
  ...
  L("TITLE",18,27,"O01 GOLD SESSION GUARD - RUNTIME PANEL v1.31",C_ACCENT,10);
  ...
  F("WARN",24,397,"Warning DD %",(string)s.warning_dd,102,52);F("PAUSE",164,397,"Grid Pause %",(string)s.pause_grid_dd,86,44);
  ...
  E("A1MIN",650,20,DoubleToString(s.atr1_min_points,1));E("A1MAX",650,42,DoubleToString(s.atr1_max_points,1));E("A2MIN",650,64,DoubleToString(s.atr2_min_points,1));E("A2MAX",650,86,DoubleToString(s.atr2_max_points,1));
  E("ONEBAR",650,108,OnOff(s.one_order_per_bar));E("GRIDOUT",650,130,OnOff(s.allow_grid_outside_time));E("PGTR",650,152,OnOff(s.pause_grid_while_trailing));
  E("STSTEP",650,174,(string)s.single_trail_step);E("BTD",650,196,(string)s.basket_trail_distance);E("BTSTEP",650,218,(string)s.basket_trail_step);E("NEWSMO",650,240,OnOff(s.news_manage_only));
