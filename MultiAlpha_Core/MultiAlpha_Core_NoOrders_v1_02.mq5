...
//| Unified A10/A12/A15/A16 host using MultiAlpha interface.         |
...
int OnInit()
  {
   if(InpAlpha!=ALPHA_A10 && InpAlpha!=ALPHA_A12 && InpAlpha!=ALPHA_A15 && InpAlpha!=ALPHA_A16_TEMPLATE) return INIT_PARAMETERS_INCORRECT;
