...
//| Original Logic series O01                                       |
//| Source-faithful monolithic wrapper of GSG v4 Experimental 03.   |
//| No strategy logic intentionally changed.                        |
//+------------------------------------------------------------------+
#ifndef O01_GSG_RSI30_MONOLITHIC_MODULE_V1_00_MQH
#define O01_GSG_RSI30_MONOLITHIC_MODULE_V1_00_MQH
...
//+------------------------------------------------------------------+
void O01_OnDeinit(const int reason)
{
   SavePersistentState();
...
void O01_OnChartEvent(const int id,const long &lparam,const double &dparam,const string &sparam)
{
...
#endif // O01_GSG_RSI30_MONOLITHIC_MODULE_V1_00_MQH
