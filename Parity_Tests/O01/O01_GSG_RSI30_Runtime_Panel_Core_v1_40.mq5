...
#include "..\\..\\Include\\O01\\O01_Settings_Panel_v1_41.mqh"
...
int OnInit(){
 ...
 Print("[O01_RUNTIME140_START] CORE=1.00 ADAPTER=1.20 PANEL=1.41 FOUNDATION=1.40 instance=",strategy.instance_id," symbol=",strategy.symbol," entry=",strategy.entry_module," manage=",strategy.manage_module," exit=",strategy.exit_module," EXECUTION=NO_ORDERS VIRTUAL_NOT_FILL=1");
